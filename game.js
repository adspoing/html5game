...
function render() {
	...
	for (var i = 0; i < map.length; i++) {
		for (var j = 0; j < map[i].length; j++) {
			...
			if (map[i][j] == -2) {
				ctx.drawImage(jineng,0,0,50,50,j * 50, i * 50 - 10, 50, 50);
			}
			if (map[i][j] == -3) {
				ctx.drawImage(chunqiu,0,0,50,50,j * 50, i * 50 - 10, 50, 50);
			}
			if(map[i][j]==-4)
			{
				ctx.drawImage(shan,0,0,40,40,j*50,i*50-10,40,40);
			}
		}
	}
}
...
function main(timestamp) {
	var dt = Math.floor(timestamp - last_timestamp);
	last_timestamp += dt;
